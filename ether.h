#ifndef MICROPS_ETHER_H
#define MICROPS_ETHER_H
...
extern int ether_transmit_helper(struct net_device *dev, uint16_t type, const uint8_t *data, size_t len, const void *dst,
